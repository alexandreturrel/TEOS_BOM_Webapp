<%@ Page Title="Template" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TemplateDetails.aspx.cs" Inherits="BomShopping2.Views.WebForm2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <asp:FormView ID="templateDetail" runat="server" ItemType="BomShopping2.Models.Template" SelectMethod ="GetTemplate" RenderOuterTable="false">
        <ItemTemplate>
            <div>
            ...
            <table>
                <tr> 
                    <td style="vertical-align: top; text-align:left;">
                        ...
                        <br />
                        <span><b>Product Number:</b>&nbsp;<%#:Item.TemplateID %></span>
                        <br />
                    </td>
                </tr>
            </table>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                  <h3><a href="AddToCart.aspx?templateID=<%#:Item.TemplateID %>&quantity=1">Add all items to cart</a></h3>
              </div>
            </div>
    ...
    <a runat="server" href="~/Views/TemplateList">Back to Templates</a>
